...
class MobileVit(nn.Module):
    ...
    def forward(self, x):
        out3 = self.model.features[0:6](x)
        out4 = self.model.features[6:8](out3)
        out5 = self.model.features[8:12](out4)
        return out3, out4, out5
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, backbone="mobilenetv2", pretrained=False):
        ...
        if backbone == "mobilenetv1":
            ...
            #   52,52,40；26,26,112；13,13,160
            # ---------------------------------------------------#
            self.backbone = MobileVit(pretrained=pretrained)
    ...
    def forward(self, x):
        ...
        # 26,26,256 + 26,26,256 -> 26,26,512
        P4 = torch.cat([P3_downsample, P4*2], axis=1)
        # 26,26,512 -> 26,26,256 -> 26,26,512 -> 26,26,256 -> 26,26,512 -> 26,26,256
